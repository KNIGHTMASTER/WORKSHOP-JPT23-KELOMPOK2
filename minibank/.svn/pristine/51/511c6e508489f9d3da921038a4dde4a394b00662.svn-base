...
public class UserDaoHibernate extends BaseDaoHibernate implements UserDao, UserDetailsService {
    /**
     * @see id.co.telkomsigma.dao.UserDao#getUser(Long)
     */
    ...
    /**
     * @see id.co.telkomsigma.dao.UserDao#getUsers(id.co.telkomsigma.model.User)
     */
    ...
    /**
     * @see id.co.telkomsigma.dao.UserDao#saveUser(id.co.telkomsigma.model.User)
     */
    ...
    /**
     * @see id.co.telkomsigma.dao.UserDao#removeUser(Long)
     */
