...
import id.co.telkomsigma.service.MailEngine;
import id.co.telkomsigma.service.RoleManager;
import id.co.telkomsigma.service.UserExistsException;
import id.co.telkomsigma.service.UserManager;
import id.co.telkomsigma.util.StringUtil;
import id.co.telkomsigma.webapp.action.minibank.CIFForm;
import id.co.telkomsigma.webapp.util.RequestUtil;
    ...
    public ILink save(IRequestCycle cycle) throws UserExistsException {
        ...
        if (!fromList && user.getUsername().equals(getRequest().getRemoteUser())) {
            ...
            if ("X".equals(request.getParameter(("version")))) {
                ...
                cycle.activate("userForm");
                cycle.activate("cifForm");
            	CIFForm nextPage = (CIFForm) cycle.getPage("cifForm");
            	nextPage.setUser(getUser());
